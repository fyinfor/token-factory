	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/channel-pricing/:channel_id/time-pricing/rules", controller.GetChannelModelRateRules)
				selfRoute.POST("/channel-pricing/:channel_id/time-pricing/rules", controller.CreateChannelModelRateRules)
				selfRoute.PUT("/channel-pricing/:channel_id/time-pricing/rules/:schedule_id", controller.UpdateChannelModelRateRule)
				selfRoute.DELETE("/channel-pricing/:channel_id/time-pricing/rules/:schedule_id", controller.DeleteChannelModelRateRule)
				selfRoute.GET("/channel-pricing/:channel_id/time-pricing", controller.GetChannelModelTimePricing)
				selfRoute.POST("/channel-pricing/:channel_id/time-pricing/plans", controller.CreateChannelModelPricePlan)
				selfRoute.PUT("/channel-pricing/:channel_id/time-pricing/plans/:plan_id", controller.UpdateChannelModelPricePlan)
				selfRoute.DELETE("/channel-pricing/:channel_id/time-pricing/plans/:plan_id", controller.DeleteChannelModelPricePlan)
				selfRoute.POST("/channel-pricing/:channel_id/time-pricing/schedules", controller.CreateChannelModelPriceSchedule)
				selfRoute.PUT("/channel-pricing/:channel_id/time-pricing/schedules/:schedule_id", controller.UpdateChannelModelPriceSchedule)
				selfRoute.DELETE("/channel-pricing/:channel_id/time-pricing/schedules/:schedule_id", controller.DeleteChannelModelPriceSchedule)
		...
		computePageAdminRoute.Use(middleware.RootAuth())
		{
			...
			computePageAdminRoute.PUT("/url", controller.AdminUpdateComputePageURL)
			computePageAdminRoute.PUT("/redirect", controller.AdminUpdateComputePageRedirect)
