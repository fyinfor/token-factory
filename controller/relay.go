...
func RelayTask(c *gin.Context) {
	...
	if taskErr == nil {
		...
		task.PrivateData.BillingContext = &model.TaskBillingContext{
			...
			TimePricingScheduleID:       relayInfo.PriceData.TimePricingScheduleID,
			TimePricingPlanID:           relayInfo.PriceData.TimePricingPlanID,
			TimePricingPlanVersion:      relayInfo.PriceData.TimePricingPlanVersion,
			TimePricingScheduleName:     relayInfo.PriceData.TimePricingScheduleName,
			TimePricingPlanName:         relayInfo.PriceData.TimePricingPlanName,
			TimePricingTimezone:         relayInfo.PriceData.TimePricingTimezone,
			TimePricingWeekdays:         relayInfo.PriceData.TimePricingWeekdays,
			TimePricingStartMinute:      relayInfo.PriceData.TimePricingStartMinute,
			TimePricingEndMinute:        relayInfo.PriceData.TimePricingEndMinute,
			TimePricingEffectiveFrom:    relayInfo.PriceData.TimePricingEffectiveFrom,
			TimePricingEffectiveTo:      relayInfo.PriceData.TimePricingEffectiveTo,
			TimePricingMatchedAt:        relayInfo.PriceData.TimePricingMatchedAt,
			TimePricingPayload:          relayInfo.PriceData.TimePricingPayload,
