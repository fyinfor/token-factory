...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"logo":                            common.Logo,
		"seo_title":                       strings.TrimSpace(common.OptionMap["SeoTitle"]),
		"seo_title_en":                    strings.TrimSpace(common.OptionMap["SeoTitleEn"]),
		"seo_description":                 strings.TrimSpace(common.OptionMap["SeoDescription"]),
		"seo_description_en":              strings.TrimSpace(common.OptionMap["SeoDescriptionEn"]),
		"seo_keywords":                    strings.TrimSpace(common.OptionMap["SeoKeywords"]),
		"seo_canonical_url":               strings.TrimSpace(common.OptionMap["SeoCanonicalUrl"]),
		"seo_og_image":                    strings.TrimSpace(common.OptionMap["SeoOgImage"]),
		"seo_robots":                      strings.TrimSpace(common.OptionMap["SeoRobots"]),
		...
		"perf_overview_enabled": cs.PerfOverviewEnabled,
...
func GetAbout(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"data": gin.H{
			...
			"about_en": common.OptionMap["AboutEn"],
		},
	})
	return
}
