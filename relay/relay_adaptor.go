...
import (
	...
	"github.com/QuantumNous/new-api/relay/channel/hidreamimage"
...
func GetAdaptor(apiType int) channel.Adaptor {
	...
	case constant.APITypeHiDreamImage:
		return &hidreamimage.Adaptor{}
	case constant.APITypeAliASR:
		return &aliyunasr.Adaptor{}
	}
	return nil
}
...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	...
	if channelType, err := strconv.ParseInt(string(platform), 10, 64); err == nil {
		...
		case constant.ChannelTypeDoubaoVideo, constant.ChannelTypeSeedance, constant.ChannelTypeVolcEngine:
