...
import ErrorLogDetailModal from './modals/ErrorLogDetailModal';
...
const LogsPage = () => {
  ...
  return (
    <>
      ...
      <ErrorLogDetailModal
        visible={logsData.errorLogDetail?.visible}
        logRecord={logsData.errorLogDetail?.record}
        onClose={logsData.closeErrorLogDetail}
        t={logsData.t}
      />
