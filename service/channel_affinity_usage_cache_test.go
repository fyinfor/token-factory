...
func uniqueChannelAffinityUsageCacheTestValue(prefix string) string {
	return fmt.Sprintf("%s_%d", prefix, channelAffinityUsageCacheTestSeq.Add(1))
}

func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityUsageCacheTestValue("rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityUsageCacheTestValue("fp")
